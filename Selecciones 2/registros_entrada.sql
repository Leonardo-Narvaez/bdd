...
-- seleción II
select * from registros_entrada where fecha between '01/09/2025' and '30/09/2025'
or cedula_empleado like '17%';

select * from registros_entrada where fecha between '01/08/2025' and '31/08/2025'
